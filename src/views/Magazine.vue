...
import majalah1 from "../assets/img/depan.jpg";
import majalah2 from "../assets/img/2.jpg";
import majalah3 from "../assets/img/3.jpg";
import majalah4 from "../assets/img/4.jpg";
import majalah5 from "../assets/img/5.jpg";
import majalah6 from "../assets/img/6.jpg";
import majalah7 from "../assets/img/7.jpg";
import majalah8 from "../assets/img/8.jpg";
import majalah9 from "../assets/img/9.jpg";
import majalah10 from "../assets/img/10.jpg";
import majalah11 from "../assets/img/11.jpg";
import majalah12 from "../assets/img/12.jpg";
import majalah13 from "../assets/img/13.jpg";
import majalah14 from "../assets/img/14.jpg";
import majalah15 from "../assets/img/15.jpg";
import majalah16 from "../assets/img/video.webp";
import majalah17 from "../assets/img/video.webp";
import majalah18 from "../assets/img/belakang.jpg";
// import $ from "jquery";
...
<template>
  <main>
    ...
    <div class="magazine">
      ...
      <div class="setting-show" :class="[toggleView ? 'trans-0' : 'trans-x-100']">
        <div class="content">
          <div class="heading">
            <h3>General</h3>
          </div>
          <div class="audio">
            ...
            <div class="audio-setting d-flex">
              ...
              <div class="toggle ms-auto" >
                <input type="checkbox" @click="(toggleSwitch = !toggleSwitch), playAudio()"
                class="toggle-switch"/>
              </div>
            </div>
          </div>
